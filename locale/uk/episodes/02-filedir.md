...
- Використовуйте довгу опцію у скриптах для наочності.
  Вона буде надрукована лише один раз, але прочитана багато разів.
...
Різниця між `cd ..` і `cd -` полягає в тому, що перший переміщується на один рівень _вище_ в ієрархії каталогів, а другий повертає вас _назад_.
